...
Your task is to write a `solve()` function that searches for the best sequence of coefficients. All numbers in your sequence have to be positive or zero.

You may code up any search method you want. The function must return a list of non-negative floats.
